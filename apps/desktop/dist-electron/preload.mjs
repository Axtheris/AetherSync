...
electron.contextBridge.exposeInMainWorld("electronAPI", {
  ...
  fs: {
    ...
    getRecentFiles: (limit) => electron.ipcRenderer.invoke("fs:get-recent-files", limit),
    generateThumbnail: (filePath) => electron.ipcRenderer.invoke("fs:generate-thumbnail", filePath)
  },
  // Window controls
  window: {
